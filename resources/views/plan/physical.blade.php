...
@section('content')
            ...
            <div class="row">
                <div class="flip-box-inner  card-display ">
                    <div class="flip-box-front">
                        <div class=" postion-r postion-r-front">
                            <div class="caption-front">
                                <img src="{{ $SER }}/assets/card-images/logo2.png" class="mx-auto d-block img-logo">
                            </div>
                        </div>
                    </div>
                    <div class="flip-box-back ">
                        <div class="postion-r postion-r-back">
